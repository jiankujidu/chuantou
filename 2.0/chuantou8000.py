...
def update():
    ...
    try:
        r1 = requests.get("https://ghproxy.com/https://raw.githubusercontent.com/jiankujidu/chuantou/main/2.0/chuantou8000.py").text
        ...
        if float(r2) > version:
            ...
            os.system("https://ghproxy.com/https://raw.githubusercontent.com/jiankujidu/chuantou/main/2.0/chuantou8000.py &")
    except:
        pass
...
def download_ngrok():
    if not os.path.exists("ngrok.py"):
        res = requests.get("https://raw.githubusercontent.com/jiankujidu/chuantou/main/2.0/ngrok8000.py")
...
def get_server():
    try:
        res = requests.get("https://ghproxy.com/https://raw.githubusercontent.com/jiankujidu/chuantou/main/2.0/server.fd8000").text
