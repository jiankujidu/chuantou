...
# 原项目地址: https://github.com/hauntek/python-ngrok
# Modify by lstcml on 2022/05/10
# Version: v1.1
import json
import logging
import socket
...
host = sys.argv[1]  # Ngrok服务器地址
port = int(sys.argv[2])  # 端口
bufsize = 1024  # 吞吐量
subdomain = sys.argv[3] # 域名前缀
http_auth = sys.argv[4] # HTTP认证
