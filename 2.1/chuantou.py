...
def update():
    ...
    try:
        r1 = requests.get("https://ghproxy.com/https://raw.githubusercontent.com/jiankujidu/chuantou/main/2.1/chuantou.py").text
        ...
        if float(r2) > version:
            ...
            os.system("ql raw https://ghproxy.com/https://raw.githubusercontent.com/jiankujidu/chuantou/main/2.1/chuantou.py &")
    except:
        pass
...
def download_ngrok():
    if not os.path.exists("ngrok.py"):
        res = requests.get("https://ghproxy.com/https://raw.githubusercontent.com/jiankujidu/chuantou/main/2.1/ngrok.py")
